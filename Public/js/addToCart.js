...
export const goToCart=function ( id, price, name, imgSrc, category, color,model,qn=1) {
...
export const ManageAddToCart=function(){
  body.addEventListener( 'click', function ( e ) {
    if ( e.target.classList.contains( 'add_to_cart' ) ) {
      ...
      goToCart( id, price, name, imgSrc,category,color,model )
      ...
      console.log( qn );
      goToCart( id, price, name, imgSrc, category, color, model,qn);
